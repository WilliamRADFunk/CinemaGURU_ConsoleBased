...
void runInstructions()
{
    ...
    cout << "X" << endl << "X";
    BlankSpaces(3);
    cout << "offered snack types by one. A random number is picked in each turn,";
    BlankSpaces(7);
    cout << "X" << endl << "X";
    BlankSpaces(3);
    cout << "and is then used to calculate how many snacks can be sold. The";
    BlankSpaces(12);
    cout << "X" << endl << "X";
    BlankSpaces(3);
    cout << "larger variety of snacks, however, increases that number.";
    BlankSpaces(17);
    cout << "X" << endl;
    XBorderedBlankSpace();
    XBorderedDivider();
